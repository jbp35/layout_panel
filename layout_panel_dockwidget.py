...
class LayoutPanelDockWidget(QtWidgets.QDockWidget, FORM_CLASS):
    ...
    def updateLayoutWidgetList(self): # Regenerate the list of layouts
        ...
        for layout in layoutlist:
            ...
            if match:
                ...
                item.setIcon(QtGui.QIcon(':/plugins/LayoutPlugin/icons/mIconLayout.svg'))
    ...
    def updateTemplateMenu(self): # Generate the template menu
        ...
        if not layoutTemplateList:
            layoutTemplateAction = menu.addAction(QtGui.QIcon(":/plugins/LayoutPlugin/icons/mActionNewLayout.svg"),'Template folder is empty')
        ...
        for layoutTemplatePath in layoutTemplateList:
            ...
            layoutTemplateAction.setIcon(QtGui.QIcon(":/plugins/LayoutPlugin/icons/mActionNewLayout.svg"))
        ...
        openTemplateFolderAction = menu.addAction(QtGui.QIcon(":/plugins/LayoutPlugin/icons/mIconFolder.svg"),"Open Template Folder")
    ...
    def openContextMenu(self, position): # Create the contextual menu
        ...
        if len(selectedLayouts)==0: #Context menu if no layout is selected
            menu = QtWidgets.QMenu()
            newLayoutAction = menu.addAction(QtGui.QIcon(":/plugins/LayoutPlugin/icons/mActionNewLayout.svg"), "New Print Layout")
            menu.addSeparator()
            exportMenu = menu.addMenu("Export All Layouts as...")
            exportPDFAction = exportMenu.addAction(QtGui.QIcon(":/plugins/LayoutPlugin/icons/mActionSaveAsPDF.svg"),"Export as PDF")
            exportImageAction = exportMenu.addAction(QtGui.QIcon(":/plugins/LayoutPlugin/icons/mActionSaveMapAsImage.svg"),"Export as Image")
            exportSvgAction = exportMenu.addAction(QtGui.QIcon(":/plugins/LayoutPlugin/icons/mActionSaveAsSVG.svg"),"Export as SVG")
            ...
            menu = QtWidgets.QMenu()
            openAction = menu.addAction(QtGui.QIcon(":/plugins/LayoutPlugin/icons/mIconLayout.svg"),"Open Layout")
            removeAction = menu.addAction(QtGui.QIcon(":/plugins/LayoutPlugin/icons/mActionDeleteSelected.svg"),"Remove Layout...")
            duplicateAction = menu.addAction(QtGui.QIcon(":/plugins/LayoutPlugin/icons/mActionDuplicateLayout.svg"), "Duplicate Layout")
            ...
            menu = QtWidgets.QMenu()
            removeAction = menu.addAction(QtGui.QIcon(":/plugins/LayoutPlugin/icons/mActionDeleteSelected.svg"),"Remove Layouts...")
            duplicateAction = menu.addAction(QtGui.QIcon(":/plugins/LayoutPlugin/icons/mActionDuplicateLayout.svg"),"Duplicate Layouts")
            menu.addSeparator()
