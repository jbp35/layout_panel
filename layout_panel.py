...
class LayoutPanel:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('LayoutPanel', message)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = LayoutPanelDockWidget()
